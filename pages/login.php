...
require('navbar.php');
# Checks if user is logged in, if yes it'll redirect him
...
<head>
    ...
    <title>BedrockPlexus | Login</title>
</head>
<body>
<div class="start_text">
<br>
<h1 class="title" style="font-size:50px;">Login</h1>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="loginForm" method="POST">
    ...
    <div class="input-box">
        ...
        <label>
     <input name= "login_password" type="password" placeholder="Password" id="password" />
        </label>
    ...
    <div class="add_server_div">
        <button style="align-content: center" class="standard_button">Login</button>
    </div>
</form>
<div class="info-text">
    <br>
    <h1 style="font-size:35px;">Don't have an account yet?</h1>
    <p style="font-size:20px;">You can create one <a class="hyperlink" href="register.php">here</a>.</p>
    <br>
</div>
<br>
</div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!empty($username) || !empty($password)){
        # Check username
        if(!Login::checkPass($username, $password)){
            echo '<div class="server"><h1 style="font-size:20px; text-align: center">Username or Password invalid.</h1></div><br>';
        }
        else{
            if(Login::getID($username) == -1){
                echo '<div class="server"><h1 style="font-size:20px; text-align: center">Internal Server Error</h1></div><br>';
            }
            else{
                $_SESSION["loggedin"] = true;
                $_SESSION["id"] = Login::getID($username);
        ...
        echo '<div class="server"><h1 style="font-size:20px; text-align: center">Username or Password is empty.</h1></div><br>';
    }
